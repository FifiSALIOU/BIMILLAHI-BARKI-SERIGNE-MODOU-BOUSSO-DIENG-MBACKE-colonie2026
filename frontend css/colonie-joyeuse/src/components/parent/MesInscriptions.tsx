...
export default function MesInscriptions() {
  ...
  const getValidationMessage = (enfant: typeof enfants[0]): {
    ...
    if (validation === 'validé') {
      return { icon: <CheckCircle2 className="w-4 h-4 text-emerald-600" />, text: '✅ Le gestionnaire a approuvé cette demande. Les informations de votre enfant sont validées.', color: 'bg-emerald-50 border-emerald-200 text-emerald-800' };
    }
